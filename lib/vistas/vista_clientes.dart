...
import '../widgets/app_scaffold.dart'; // Importamos el nuevo AppScaffold
...
class ClientesScreenState extends State<ClientesScreen> {
  ...
  Widget build(BuildContext context) {
    // AQUÍ ESTÁ EL CAMBIO PRINCIPAL - Usamos AppScaffold en lugar de Scaffold
    return AppScaffold(
      title: 'Gestión de Clientes',
      currentRoute: '/clientes',
      // Pasamos acciones específicas para el AppBar
      actions: [
        IconButton(
      ...
      // El body contiene todo el contenido existente
      body:
          _isLoading
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (_selectedCliente!.fechaRegistro !=
                                            null)
                                          _buildDetailRow(
                                            'Fecha de registro',
