...
class HistorialTransaccionesWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HistorialTransaccionesWidget> createState() => _HistorialTransaccionesWidgetState();
}

class _HistorialTransaccionesWidgetState extends ConsumerState<HistorialTransaccionesWidget> {
                ...
                if (widget.esRenta) // Solo mostrar botón para rentas
                  TextButton.icon(
                    ...
                    onPressed: () {
                      setState(() {
                        _showForm = !_showForm;
                        _movimientoSeleccionadoId = null;
                      });
                    },
                  ),
              ],
        ...
        children: [
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(
              ...
              hintText: 'Ej: Pago de renta mensual, reparación, etc.',
            ),
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final nombreArchivo = archivo['tempPath'].toString().split('/').last;
          ...
          data: (movimientos) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final esPago = movimiento.concepto.toLowerCase().contains('pago') ||
                ...
                return Card(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(
                      color: esPago ? Colors.green.shade200 : Colors.orange.shade200,
                      width: 1,
                    ),
                  ),
                  child: ListTile(
                    ...
                    trailing: Column(
                      ...
                      children: [
                        Text(
                          NumberFormat.currency(symbol: '\$', locale: 'es_MX').format(movimiento.monto),
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: esPago ? Colors.green.shade700 : Colors.orange.shade700,
                          ),
                        ),
  ...
  Widget _buildDetallesMovimiento(MovimientoRenta movimiento) {
    return Column(
      ...
      children: [
        ...
        _buildInfoDetalle('Monto', NumberFormat.currency(symbol: '\$', locale: 'es_MX').format(movimiento.monto)),
        _buildInfoDetalle('Fecha', DateFormat('dd/MM/yyyy').format(movimiento.fechaMovimiento)),
        _buildInfoDetalle('Tipo', movimiento.tipoMovimiento),
        if (movimiento.comentarios != null && movimiento.comentarios!.isNotEmpty)
    ...
    return Consumer(
      builder: (context, ref, child) {
        ...
        return comprobantesAsyncValue.when(
          data: (comprobantes) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final esPdf = comprobante.tipoArchivo == 'pdf' || 
                ...
                return ListTile(
                  ...
                  title: Text(comprobante.descripcion ?? 'Comprobante ${index + 1}'),
          ...
          loading: () => const Center(child: CircularProgressIndicator()),
          error: (error, stack) => Center(
            child: Text('Error al cargar comprobantes: $error'),
          ),
        );
      },
    );
  ...
  Future<void> _agregarArchivo() async {
    ...
    try {
      ...
      AppLogger.error('Error al agregar archivo', e, stack);
      if (mounted) {
      ...
      if (_archivosTemporal.isNotEmpty) {
        for (final archivo in _archivosTemporal) {
          final comprobante = ComprobanteMovimiento(
            ...
            tipoArchivo: 'pdf', // Por defecto asumimos PDF
